...
class DF_ad125x125 extends WP_Widget {
	...
	function form($instance) {
		...
		$defaults = array(
			'image1' => THEME_IMAGE_URL."125x125.gif",
			'link1' => 'http://www.different-themes.com',
			'image2' => THEME_IMAGE_URL."125x125.gif",
			'link2' => 'http://www.different-themes.com',
			'image3' => THEME_IMAGE_URL."125x125.gif",
			'link3' => 'http://www.different-themes.com',
			'image4' => THEME_IMAGE_URL."125x125.gif",
		...
		<ul class="ad-blocks-125">
			<?php 
				...
				for($i=1; $i<=4; $i++) {
					...
					if(!$image) { $image = THEME_IMAGE_URL."125x125.gif"; }
					if($link) {
			?>
				<li>
