...
<?php get_template_part(THEME_LOOP."loop","start"); ?> 
	<?php if($mail_to) { ?>
	        ...
	        <div class="blank-page-container">
	            ...
	            <div id="contact">
					<div id="message" style="display: none;">
						<div class="error_message"><?php _e("Pozor! Vyplňte vše potřebné..",THEME_NAME);?>
							<ul class="error_messages cross">
								<li class="name" style="display: none;">Jméno je <strong>povinné</strong>.</li>
								<li class="email" style="display: none;"><?php _e("E-mail je <strong>povinný</strong>.",THEME_NAME);?></li>
								<li class="message" style="display: none;"><?php _e("Musíte <strong>napsat zprávu</strong>.",THEME_NAME);?></li>
							</ul>
						</div>
						<div class="success" style="display: none;"><?php _e("Zpráva úspěšně odeslána!",THEME_NAME);?></div>
					</div>
	                <form method="post" name="contactform" id="contactform">
	                    ...
	                    <div id="contact-input">
	                        <div>
	                        	<label for="name"><?php _e("Jméno",THEME_NAME);?></label>
	                    ...
	                    <div id="contact-message">
	                        <label for="comments"><?php _e("Zpráva",THEME_NAME);?></label>
	                        <textarea name="comments" type="text" id="comments" value=""></textarea>
	                    </div>      
	                    <div id="contact-submit">
	                        <input type="submit" class="submit" id="submit" value="<?php _e("Odeslat",THEME_NAME);?>">
	                    </div>
	                </form>
	            </div>
		    </div> 
		...
		<?php endif; ?>
	<?php } else { echo "<p style=\"color:#000; font-size:14pt; text-align: center; padding: 30px 0 10px 0;\">Vyplňte email!</p>"; } ?>
