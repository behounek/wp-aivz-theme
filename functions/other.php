 ...
 * -------------------------------------------------------------------------*/
	...
	$my_meta->addSelect($prefix.'blog_style',array('1'=>'Default','2'=>'3 posts in row','3'=>'2 posts in row','4'=>'1 posts in row'),array('name'=> __('Category Style ','category'), 'std'=> array('selectkey2')));
	$my_meta->Finish();
...
function df_rating_html($stars) {


?>
    <div class="review-stars" title="<?php _e("Rating: ", THEME_NAME); echo $stars[0];?>">
        <?php
            $i = 1;
            //full stars
            while ($i <= $stars[1] - 1) {
        ...
        <?php 
            ...
            //empty stars
            $emptyI = floor((10 - $stars[1])/2);
            $ii = 1;
            for ($ii=1; $ii<=$emptyI;$ii++) {
        ?>
 ...
 * -------------------------------------------------------------------------*/
 ...
 function df_image_html($id, $width=0, $height=0) {
	...
	$return = '<img class="image-border" src="'.$image["src"].'" alt="'.get_the_title($id).'" title="'.get_the_title($id).'" />';
	return $return;
}
...
function accommodation_icons($value) {
	switch ($value) {
	    case "wifi":
	        $text = __("Free WiFi",THEME_NAME);
	        break;
	    case "tv":
	        $text = __("TV and satelitte",THEME_NAME);
	        break;
	    case "service-24":
	        $text = __("24/7 Room service",THEME_NAME);
	        break;
	    case "bar":
	        $text = __("Room bar",THEME_NAME);
	        break;
	    case "sef":
	        $text = __("Safe deposit",THEME_NAME);
	        break;
	    case "loundry":
	        $text = __("Loundry service",THEME_NAME);
	        break;
	    case "for-disabled":
	        $text = __("Access for disabled",THEME_NAME);
	        break;
	    case "no-smooking":
	        $text = __("No smooking",THEME_NAME);
	        break;
	    case "pets":
	        $text = __("Pets allowed",THEME_NAME);
	        break;
	    case "no-pets":
	        $text = __("Pets not allowed",THEME_NAME);
	        break;
	    case "parking":
	        $text = __("Parking",THEME_NAME);
	        break;
	    case "swimming-pool":
	        $text = __("Swimming pool",THEME_NAME);
	        break;
	    case "hair-dryer":
	        $text = __("Hair dryer",THEME_NAME);
	        break;
	    case "dinner":
	        $text = __("Dinner included",THEME_NAME);
	        break;
	    case "barbershop":
	        $text = __("Hotel barbershop",THEME_NAME);
	        break;
	    case "giftshop":
	        $text = __("Hotel giftshop",THEME_NAME);
	        break;
	    case "wellness":
	        $text = __("Hotel wellness",THEME_NAME);
	        break;
	    case "tennis":
	        $text = __("Hotel tennis",THEME_NAME);
	        break;
	    case "cocktailbar":
	        $text = __("Hotel cocktail bar",THEME_NAME);
	        break;
	    case "gym":
	        $text = __("Hotel gym",THEME_NAME);
	        break;
	    case "kids":
	        $text = __("Kids",THEME_NAME);
	        break;
	    case "doctor":
	        $text = __("Hotel doctor",THEME_NAME);
	        break;
	    case "library":
	        $text = __("Hotel library",THEME_NAME);
	        break;
	    case "currency-exchange":
	        $text = __("Currency exchange office",THEME_NAME);
	        break;
...
$orangethemes_buttons=array("differentthemesheading","differentthemesdropcaps","differentthemespreformated","differentthemesmarker","differentthemesmiscellaneous","differentthemeslist","differentthemestables","differentthemesbutton","|",
			"differentthemessocial","differentthemesicon", "differentthemesquote", "differentthemestabs", "differentthemestoggles", "differentthemesalert", "|", "differentthemescolumns", "differentthemestooltip", "differentthemesvideo", "differentthemesclear", "differentthemesspacer");
   ...
   ?>
	<li <?php comment_class('comment'); ?> id="li-comment-<?php comment_ID(); ?>">
		<article id="comment-<?php comment_ID(); ?>">
			<img src="<?php echo df_get_avatar_url(get_avatar( $comment, 60));?>" class="comment-avatar" alt="<?php _e( 'Avatar' , THEME_NAME );?>">
