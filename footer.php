...
<div id="copyright">
    <div class="container">
      ...
      <div class="copyright-block">
        	<p>&copy; <?php echo date("Y");?> <a href="http://themeforest.net/user/different-themes?ref=different-themes" target="_blank">iMagPress</a>. <?php _e("All Rights Reserved.", THEME_NAME);?></p>
        	<p class="disclaimer">
